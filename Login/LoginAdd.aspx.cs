            ...
            else
            {
                ...
                if (RadioButton1.Checked)
                {
                    ...
                    if (msg == "男")
                    {
                        ...
                        sb.Append("VALUES(" + serial_ID + ",'" + base64NID + "', '" + EMP_ID.Text + "', '" + EMP_Name.Text + "', '" + base64String + "','" + EMP_Mail.Text + "', " + intMsg + ", '" + EMP_Phone.Text + "', '" + DropDownList1.Text + "', " + result + ", " + "SYSDATE" + ", " + "SYSDATE" + ")");

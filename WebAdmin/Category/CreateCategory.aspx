...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>類別代碼</p>
    <asp:TextBox ID="CategoryCode" runat="server" Width="44px"></asp:TextBox><asp:Label ID="Label1" runat="server"></asp:Label>
    <br />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="CategoryCode" runat="server" ErrorMessage="類別代碼為空"></asp:RequiredFieldValidator>
    <p>類別名稱</p>
